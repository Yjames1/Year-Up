...
public class ReverseOutofPlace 
{
	...
	private static final char temp = 0;
	...
	System.out.println("The reverse of " + " is " + reversedString);
	}
	...
	if (originalString !=null)
	{
		...
		{
			char string= originalStringCharacters[j];
...
public static String ReverseOutOfPlace(String originalString)
{
	...
	if(originalString != null)
	{
		...
		for(int i = 0, j = originalStringCharacters.length; i < originalStringCharacters.length/2; i++, j--)
		{
